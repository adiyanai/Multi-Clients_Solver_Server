...
//            searchResult.shortestPathRoute = "Source is invalid\n";
//            return searchResult;
//        }
//
//        // If the destination is out of range
//        if (!isValid(goalState)) {
//            searchResult.shortestPathRoute = "Destination is invalid\n";
//            return searchResult;
//        }
...
//    bool isValid(State<T> *state) {
//        // Returns true if row number and column number
//        // is in range
//        return (!(state->getState() < searchable->getBoundedOfSearchable().first)) && (state->getState()
//                                                                                       <
//                                                                                       searchable->getBoundedOfSearchable().second);
//    }
